function SideNav() {
  return (
    <div className="flex max-h-screen w-16 flex-col rounded-xl overflow-hidden  justify-between border-e bg-white">
      <div>
        <div className="group inline-flex h-16 w-16 items-center justify-center">
          {/* Your span element goes here */}
          <span className="grid h-10 w-10 place-content-center rounded-lg bg-gray-100 text-xs text-gray-600 group-hover:text-gray-900">
            L
          </span>
